...
- **Only heap and growable arena implementations exist.** Fixed-buffer arenas, scratch scopes, pools/free lists, debug allocators, leak tracking, and virtual-memory reserve/commit arenas remain future stdlib/runtime work.
