...
typedef enum {
    ...
    TOK_VOID, TOK_STRUCT, TOK_BREAK, TOK_CONTINUE, TOK_ENUM,
    TOK_SWITCH, TOK_CASE, TOK_DEFAULT, TOK_CAST,
    ...
    // operators
    TOK_PLUS, TOK_MINUS, TOK_STAR, TOK_SLASH, TOK_PERCENT, TOK_PERCENT_EQUAL,
